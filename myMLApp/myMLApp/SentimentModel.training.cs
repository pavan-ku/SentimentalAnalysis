...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\pavank\source\repos\myMLApp\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.07631401F,L2Regularization=0.10075785F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
